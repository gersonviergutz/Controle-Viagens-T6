...
const TravelCard: React.FC<TravelCardProps> = ({ trip, onUpdateStatus, isUpdating, onEdit, onDelete, isDeleting }) => {
        ...
        <div className="mt-6 flex flex-col sm:flex-row sm:justify-between sm:items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
                ...
                className="mt-4 sm:mt-0 p-2 text-slate-500 hover:text-red-600 hover:bg-red-100 rounded-full focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-75 transition-colors disabled:text-slate-300 disabled:cursor-not-allowed"
            >
                {isDeleting ? (
